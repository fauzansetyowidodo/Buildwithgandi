<?php
       if (isset($_SESSION['id_user'])) {
        ...
        if (empty($nama)) {
            header("Location:edit-user-data-".$id_user."_notif-namakosong");
        }elseif (empty($email)) {
            header("Location:edit-user-data-".$id_user."_notif-emailkosong");
        }elseif (empty($username)) {
            header("Location:edit-user-data-".$id_user."_notif-usernamekosong");
        }else {
