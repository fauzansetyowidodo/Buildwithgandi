<?php 
  $id_konten = $_GET['data'];
      // get profil
      $sql = "SELECT `foto_konten`, `judul`, `isi` FROM `konten` WHERE `id_konten` = '$id_konten'";
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table class="table table-bordered">
                    <tbody>                
                    <tr>
                        <td><strong>Foto Konten<strong></td>
                        <td><img src="cover_konten/<?php echo $foto; ?>" class="img-fluid" width="200px;"></td>
                      </tr>  
                      <tr>
