      ...
      <div class="col-sm-10">
         <?php if (!empty($_GET['notif'])) { ?>
            ...
            <?php } elseif ($_GET['notif']=="emailkosong") { ?>
              <div class="alert alert-danger" role="alert">email nama wajib di isi</div>
           <?php } else if($_GET['notif']=="usernamekosong"){ ?>
            <div class="alert alert-danger" role="alert">username nama wajib di isi</div>
           <?php }?>
           
        <?php } ?>
      </div>
      <form class="form-horizontal" method="post" action="konfirmasi-edit-user" enctype="multipart/form-data">
      <div class="card-body">
            ...
            <div class="col-sm-7">
              ...
              <select class="form-control" id="jurusan" name="level">
                <option value="Superadmin" <?php if ($level=="Superadmin") {?> 
                  selected 
                <?php } ?>>Superadmin</option>
                <option value="Admin" <?php if ($level=="Admin") {?> selected 
                <?php } ?>>Admin</option>
              </select>
            </div>
          </div>
