        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="onten">Data Konten</a></li>
    ...
    <div class="card card-info">
      <div class="card-header">
        ...
        <div class="card-tools">
          <a href="konten" class="btn btn-sm btn-warning float-right"><i class="fas fa-arrow-alt-circle-left"></i> Kembali</a>
        </div>
      </div>
      <!-- /.card-header -->
      <!-- form start -->
      ...
      <?php if (!empty($_GET['notif'])) { ?>
       ...
       <?php } elseif ($_GET['notif']=="judulkosong") { ?>
           <div class="alert alert-danger" role="alert">
            Maaf Judul anda tidak boleh kosong
          </div>   
      ...
      <form class="form-horizontal" method="post" action="konfirmasi-tambah-konten" enctype="multipart/form-data">
        <div class="card-body">
          <div class="form-group row">
            <label for="foto" class="col-sm-12 col-form-label"><span class="text-info"><i class="fas fa-user-circle"></i> <u>Data Konten</u></span></label>
          </div>          
          <div class="form-group row">
